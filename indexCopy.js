...
const USER_PATH = "username/kritisanon?tweet.fields=entities&user.fields=id,created_at,name,username,verified,profile_image_url,entities";
...
function getUserTweetsData(userId) {
    const options = {
        method: 'GET',
...
app.get("/getUserDataByName",(req, res) => {
    ...
    axios.request(options).then(function (response) {
        ...
        // const userTweetsData = getUserTweetsData(userId);
        //
